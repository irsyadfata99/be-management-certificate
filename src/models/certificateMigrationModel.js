...
class CertificateModel {
  ...
  static async countByHeadBranch(headBranchId, { status, currentBranchId, search } = {}) {
  ...
  static async findByHeadBranch(headBranchId, { status, currentBranchId, search, sortBy = "certificate_number", order = "desc", limit = null, offset = null } = {}) {
    ...
    const safeSortBy = allowedSortFields.includes(sortBy) ? sortBy : "certificate_number";
